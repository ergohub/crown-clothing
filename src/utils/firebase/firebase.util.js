...
// add colections and data to firestore database
export const addCollectionAndDocuments = async (collectionKey, objectsToAdd) => {
    const collectionRef = collection(db, collectionKey);
    const batch = writeBatch(db);
    // for each object in my data array, writes the data to the database as a category 
...
export const getCategoriesAndDocuments = async () => {
    ...
    return querySnapshot.docs.map((docSnapshot) => docSnapshot.data()); // return data as an array
